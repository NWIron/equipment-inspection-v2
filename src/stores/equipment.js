  ...
  try {
    ...
    return {
      ...
      message: pickLocaleText(
        '无法连接设备管理服务，请确认 Cloudflare Pages Functions 与 D1 已完成初始化。',
        'Unable to connect to the equipment service. Confirm that Cloudflare Pages Functions and D1 have been initialized.',
      ),
    }
  }
}
